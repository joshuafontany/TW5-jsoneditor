...
export TIDDLYWIKI_PLUGIN_PATH="/d/tw/plugins"
export TIDDLYWIKI_THEME_PATH="/d/tw/themes"
export TIDDLYWIKI_EDITION_PATH="/d/tw/editions"
...
tiddlywiki --verbose --load ./index.html --render "[!is[system]tag[Character]]" "[encodeuricomponent[]addprefix[tiddlers/]addsuffix[.html]]" "text/html" "$:/core/templates/static-tiddler"